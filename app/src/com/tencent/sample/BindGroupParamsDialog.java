	...
	public void onClick(View v) {
		...
		case R.id.bt_commit:
			Bundle bundle = new Bundle();
                bundle.putString(GAME_UNION_ID, tvGameUnionId.getText() + "");
                bundle.putString(GAME_ZONE_ID, tvGameZoneId.getText() + "");
                bundle.putString(GAME_SIGNATURE, tvGameSignature.getText() + "");
                bundle.putString(GAME_UNION_NAME, tvGameUnionName.getText() + "");
